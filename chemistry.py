...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    """Compute and return the total molar mass of all the elements listed in symbol_quantity_list.
        ...
        1. For each item in the list use the element's symbol to lookup the
        atomic mass of the element in the periodic_table_dict dictionary.
        2. Multiply the elements atomic weight by the quantity of atoms for the
        element (from the symbol_quantity_list) and add that to the total mass
        3. Return the total mass."""
    total_mass = 0.0
...
def main():
    ...
    4. Call parse_formula (from provided library) 
    to get a list of elements in formula. (store in a variable).
    ...
    # Step 2
    mass_grams = float(input("Enter the sample mass in grams: "))
    ...
    # Step 6
    print(f"The molar mass of {formula} is {molar_mass:.3f} grams per mole")

    # Step 7
    moles = mass_grams / molar_mass

    # Step 8
    print(f"{mass_grams} grams of {formula} contains {moles:.5f} moles")
